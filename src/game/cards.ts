...
export const PAPAGAJ = define<UnitCardDef>({
  ...
  dice: {
    ...
    manaCost: 1,
    activation: false,
    effect: { kind: 'acidBlast', stacks: 1 },
  },
  text: {
    sk: 'Letec. Kyselina ∞: útoky trvalo znižujú brnenie. Stabilita — Kocka 1+ (1 mana): spŕška 1 kyseliny navyše, hod nemôže zlyhať.',
    en: 'Flyer. Acid ∞: attacks permanently shred armor. Stability — Dice 1+ (1 mana): 1 extra acid stack; the roll cannot fail.',
  },
  glyph: '🦜',
  art: '/art/papagaj.jpg',
});
