...
/**
 * Fáza 1: local Pass & Play — two players on one device.
 * Math.random is the RNG here; online games use the Durable Object's.
 */
export function LocalGame() {
  ...
  return (
    <div className={`flex min-h-0 flex-1 ${shake ? 'shake' : ''}`}>
